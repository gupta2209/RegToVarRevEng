...
set C_modelArgList {
	...
	{ o3 int 32 regular {pointer 0}  }
	{ o4 int 32 regular {pointer 0}  }
	{ G1 int 32 regular  }
	{ G2 int 32 regular  }
	{ G3 int 32 unused  }
	{ G4 int 32 unused  }
...
set C_modelArgMapList {[ 
	{ "Name" : "i1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "i1","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "o3", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "o3","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "o4", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "o4","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ i6 sc_in sc_lv 32 signal 4 } 
	{ o1 sc_out sc_lv 32 signal 5 } 
	{ o1_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ o2 sc_out sc_lv 32 signal 6 } 
	{ o2_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ o3 sc_in sc_lv 32 signal 7 } 
	{ o4 sc_in sc_lv 32 signal 8 } 
	{ G1 sc_in sc_lv 32 signal 9 } 
	{ G2 sc_in sc_lv 32 signal 10 } 
	{ G3 sc_in sc_lv 32 signal 11 } 
	{ G4 sc_in sc_lv 32 signal 12 } 
	{ GG1 sc_in sc_lv 32 signal 13 } 
	{ GG2 sc_in sc_lv 32 signal 14 } 
	{ ap_return1 sc_out sc_lv 32 signal 15 } 
	{ ap_return1_ap_vld sc_out sc_logic 1 outvld 15 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "o3", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "o3", "role": "default" }} , 
 	{ "name": "o4", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "o4", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "o3", "Type" : "None", "Direction" : "I"},
			{"Name" : "o4", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	hls_macc {
		...
		i2 {Type I LastRead 2 FirstWrite -1}
		i3 {Type I LastRead 0 FirstWrite -1}
		i4 {Type I LastRead 0 FirstWrite -1}
		i6 {Type I LastRead 3 FirstWrite -1}
		o1 {Type O LastRead -1 FirstWrite 4}
		o2 {Type O LastRead -1 FirstWrite 4}
		o3 {Type I LastRead 4 FirstWrite -1}
		o4 {Type I LastRead 4 FirstWrite -1}
		...
		GG1 {Type I LastRead 1 FirstWrite -1}
		GG2 {Type I LastRead -1 FirstWrite -1}
		ap_return1 {Type O LastRead -1 FirstWrite 4}}}
...
set Spec2ImplPortList { 
	...
	o3 { ap_none {  { o3 in_data 0 32 } } }
	o4 { ap_none {  { o4 in_data 0 32 } } }
