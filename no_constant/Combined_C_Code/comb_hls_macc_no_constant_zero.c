...
void state2(){
    ...
    {
        tmp_reg_257 =   ( G1  > 10 ? (zero+1) : zero ) ;
        tmp_6_reg_267 =   (  (  ( G1  > 10 ? (zero+1) : zero )  == 1 ?  ( op5_reg_246  + GG1 )  :  op5_2_reg_251  )  < op4_reg_239  ? (zero+1) : zero ) ;
        op5_1_reg_262 =   op5_reg_246  + GG1 ;
    }

    //scheduled c code
    icmp_ln16 = G1 > 10 ? (zero+1) : zero; //%icmp_ln16 = icmp sgt i32 %G1_read, 10
    op5_1 = op5 + GG1; //%op5_1 = add nsw i32 %op5, %GG1_read
    op5_3 = icmp_ln16 ? op5_1 : op5_2; //%op5_3 = select i1 %icmp_ln16, i32 %op5_1, i32 %op5_2
    icmp_ln27 = op5_3 < op4 ? (zero+1) : zero; //%icmp_ln27 = icmp slt i32 %op5_3, %op4
}
...
int main(){
	for(int i=0; i<100; i++){
		...
		scanf("%llu %llu %llu %llu %llu %llu %llu %llu %llu %llu %llu %llu %llu %llu %llu %llu",&zero,&i1__1,&i2__1,&i3__1,&i4__1,&i6__1,&o1__1,&o2__1,&o3__1,&o4__1,&G1__1,&G2__1,&G3__1,&G4__1,&GG1__1,&GG2__1);	
		int dummy = 1;
