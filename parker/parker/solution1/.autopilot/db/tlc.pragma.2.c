...
# 2 "tlc.c" 2
void tlc(int current_state,int cars,int timeOutL,int timeOutS)
{
int newstate,newHL,newFL;
int newST,FarmL,state,HiWay,StartTimer;
if(current_state==0)
{
 newHL=4;
 newFL=6;
