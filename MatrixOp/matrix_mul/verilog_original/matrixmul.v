...
(* CORE_GENERATION_INFO="matrixmul,hls_ip_2019_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.510000,HLS_SYN_LAT=205,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=3,HLS_SYN_FF=442,HLS_SYN_LUT=694,HLS_VERSION=2019_2}" *)
...
always @ (posedge ap_clk) begin
    if (((icmp_ln9_fu_285_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        ...
        zext_ln10_reg_623[1 : 0] <= zext_ln10_fu_297_p1[1 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln28_fu_514_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state15))) begin
        ...
        zext_ln30_reg_751[1 : 0] <= zext_ln30_fu_526_p1[1 : 0];
    end
end
...
assign tmp_1_fu_390_p3 = {{i_1_reg_185}, {2'd0}};

assign tmp_2_fu_450_p3 = {{i_2_reg_207}, {2'd0}};

assign tmp_3_fu_337_p3 = {{k_0_reg_174}, {2'd0}};

assign tmp_4_fu_530_p3 = {{i_3_reg_229}, {2'd0}};

assign tmp_6_fu_564_p3 = {{j_3_reg_240}, {2'd0}};

assign tmp_fu_267_p3 = {{i_0_reg_139}, {2'd0}};
...
always @ (posedge ap_clk) begin
    zext_ln10_reg_623[4:2] <= 3'b000;
    zext_ln30_reg_751[4:2] <= 3'b000;
end
