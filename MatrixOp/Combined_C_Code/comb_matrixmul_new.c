...
void state1(){
    ...
    //icmp_ln9_fu_285_p2 =   ( j_0_reg_150__temp  == 3 ? () :  0 ) ;
...
void state2_2(){
   ...
   icmp_ln11_fu_311_p2 =   ( k_0_reg_174__temp  == 3 ? (zero+1) :  zero ) ;
	...
	sub_ln12 = (i_0 << 2) - i_0; //nf//%sub_ln12 = sub i5 %zext_ln12_1, %zext_ln12
	//br label %.preheader
}
/*
void state3(){
...
void state8_2(){
    ...
    zext_ln30_reg_751 =  ( ( zext_ln30_reg_751 & 3 ) & 31 )  ;
   icmp_ln15_fu_374_p2 =   ( i_1_reg_185__temp  == 3 ? (zero+1) :  zero ) ;
	if((1 == ap_CS_fsm_state8) && (icmp_ln15_fu_374_p2 == zero))
       {
               i_2_reg_207 =  zero;
       }
       if((icmp_ln15_fu_374_p2 == zero) && (1 == ap_CS_fsm_state8))
